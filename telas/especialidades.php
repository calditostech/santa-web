...
<!DOCTYPE html>
 ...
 <body>
  ...
  <div class="mb-3">
    ...
    <input type="text" name ="especialidade" class="form-control" id="exampleInputBeneficiario" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">CBOS:</label>
    <input type="text" name ="cbos" class="form-control" id="exampleInputEspecialidade">
  </div>
