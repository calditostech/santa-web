...
<!DOCTYPE html>
 ...
 <body>
     <div class="container">
         <h2> Cadastro de beneficiarios </h2>
  ...
  <div class="mb-3">
    ...
    <input type="date" name ="data_nascimento" class="form-control" id="exampleInputEspecialidade">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">SEXO:</label>
    <input type="text" name ="sexo" class="form-control" id="exampleInputMedico">
  </div>
