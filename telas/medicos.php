...
<!DOCTYPE html>
 ...
 <body>
     <div class="container">
         <h2> Cadastro de Medicos </h2>
     <form action="../class/controllerCadastro.php" method="post">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">NOME:</label>
    <input type="text" name ="nome_medico" class="form-control" id="exampleInputBeneficiario" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">CRM:</label>
    <input type="text" name ="crm" class="form-control" id="exampleInputEspecialidade">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">DATA DE NASCIMENTO:</label>
    <input type="date" name ="data_medico" class="form-control" id="exampleInputMedico">
  </div>
