...
<!DOCTYPE html>
 ...
 <body>
  ...
  <div class="mb-3">
    ...
    <input type="text" name ="endereco" class="form-control" id="exampleInputBeneficiario" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">MEDICO:</label>
    <input type="text" name ="nome_medico" class="form-control" id="exampleInputEspecialidade">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">ESPECIALIDADE:</label>
    <input type="text" name ="especialidade_local" class="form-control" id="exampleInputMedico">
  </div>
